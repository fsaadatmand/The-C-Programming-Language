 ...
 * version of bitcount.
 *
 * Answer: It has to do with they way binary subtraction works. Subtracting 1
 * from x results in inverting the rightmost bit when it is 1, leaving the
 * other bits unchanged. This essentially will produce a mask that will delete
 ...
 * subtraction, filling any 0-bits in between with 1. This has the effect of
